...
def camera_process(_running, _speed, _direction):
    FRAME_WIDTH = 640 
    FRAME_HEIGHT = 480
...
if __name__ == '__main__':
    ...
    p_camera = multiprocessing.Process(target=camera_process, args=(RUNNING, SPEED,DIRECTION,))
    p_dump = multiprocessing.Process(target=_arduino.arduino_process, args=(RUNNING,SPEED,DIRECTION,))
    p_camera.start()
    p_dump.start()
